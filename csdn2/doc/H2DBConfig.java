...
/**
 * https://stackoverflow.com/questions/42857731/spring-h2-database-persistence
 * 配置一个数据源，需要配置{@code ManagerFactoryRef}实体关联管理工厂类
 * 和{@code TransactionManagerRef}事务管理类
 */
@Configuration
@EnableJpaRepositories(
    basePackages = "org.luncert.csdn2.repository.h2",
...
public class H2DBConfig
{
    ...
    public LocalContainerEntityManagerFactoryBean mongoEntityManagerFactory() {
        ...
        factory.setPackagesToScan("org.luncert.csdn2.repository.h2");
